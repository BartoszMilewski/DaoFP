...
Haskell code to accompany this book, including solutions to programming exercises, is available on \href{https://github.com/BartoszMilewski/Publications/tree/master/TheDaoOfFP/Haskell}{GitHub}.
...
\subfile{14-Effects}
\subfile{15-Applicatives}
\subfile{16-Monads}
\subfile{17-MonadsAdjunctions}
\subfile{18-Comonads}
\subfile{19-Ends}
\subfile{20-Tambara}
\subfile{21-Kan}
\subfile{22-Enrichment}
