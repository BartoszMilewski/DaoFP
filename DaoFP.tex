...
There is a lot of folklore knowledge in category theory and in computer science that is nowhere to be found in the literature. It's very difficult to acquire useful intuitions when going through dry definitions and theorems. I tried, as much as possible, to de-formalize mathematics, to provide the missing intuitions and explain not only the whats but also the whys. Once you get familiar with the ideas, it's easy to look up the formal definitions and theorems either in math books or online using Wikipedia, nLab, or one of the LLMs.
