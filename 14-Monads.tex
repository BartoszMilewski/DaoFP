...
When translating this to Haskell, the components of these transformation become two constructors. We define the following recursive data type parameterized by a functor \hask{f}:
\begin{haskell}
