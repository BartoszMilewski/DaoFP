...
Let's start with a monoid $(M, \mu, \eta)$ in the monoidal category $(\mathcal{C}, \otimes, I)$. We have a functor $F$ that maps $M$ to $F M$ and we want $F M$ to be a monoid in the target monoidal category $(\mathcal{D}, \oplus, J)$. For that we need to find two mappings:
\begin{align*}
\eta' &\colon J \to F M \\
...
We do have at our disposal the liftings of the original mappings:
\begin{align*}
...
J &\to F I\\
 ...
 \end{align*}
A monoidal functor would provide such arrows as halves of the defining isomorphisms. However, for what we're trying it accomplish, we don't need the other halves. We can relax the isomorphisms. 
