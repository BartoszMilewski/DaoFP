...
In Haskell, we represent a free monoid generated by some type \hask{a} as a type of lists \hask{[a]}. Concatenation of lists is defined by:
\begin{haskell}
concat :: [a] -> [a] -> [a]
concat [] as = as
...
For instance, the free monoid generated by \hask{Bool} contains an empty list \hask{[]} as a unit; two generators as singleton lists, \hask{[True]} and \hask{[False]}; their concatenations, \hask{[True, True]}, \hask{[True, False]}, \hask{[False, True]}, \hask{[False, False]}; and so on.
