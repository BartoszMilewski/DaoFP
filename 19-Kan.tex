...
that is called a \index{co-power}\emph{co-power}.
...
Similarly, we can express powering as iterated multiplication. We use the same right-hand side, but this time we use the mapping-in to define the \index{power}\emph{power}:
