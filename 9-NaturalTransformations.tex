...
The standard \index{Yoneda trick}Yoneda trick is to make a substitution for $x$ that would reduce one of the hom-sets to an endo-hom-set, that is a hom-set whose source is the same the target. This will allow us to pick a canonical element of that hom-set, that is the identity arrow.
...
\begin{exercise}
The list functor is not representable. But can it be considered a sum of representables?
\end{exercise}
