...
Functoriality can be expressed in Haskell using a \index{\hask{class}}\emph{typeclass}. In this case, the typeclass is parameterized by a type constructor \hask{f}. We say that \hask{f} is a \hask{Functor} if there is a corresponding mapping of functions called \hask{fmap}:
\begin{haskell}
