...
If we think of morphisms as actions, their tensor product corresponds to performing two actions in parallel. Contrast this with the composition of morphisms, which suggests their temporal ordering.
